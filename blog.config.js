...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'mediun', // 主题， 支持 ['next','hexo',"fukasawa','medium','example'] @see https://preview.tangly1024.com
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || true, // 是否显示切换主题按钮
  LANG: process.env.NEXT_PUBLIC_LANG || 'en-US', // 默认语言设置 e.g 'zh-CN','en-US'  see /lib/lang.js for more.
